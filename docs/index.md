...
!!! faq "Eau et Lave infini ?"
    ...
    Il est possible d'avoir de la lave ![Lave](images/sources/lave.webp "Lave"){ width=30 } à l'infini, mais cela concerne les joueurs jouant à partir de la version 1.17 étant donné que les stalactiques sont apparues pour la première fois en 1.17 et ![Stalactique](images/blocs/stalactique.webp "Stalactique"){ width=30 } qui ont permis aux joueurs d'avoir une source de lave infini dans l'overworld.  
...
!!! info "Des fermes à or "
    ...
    Je vous présente un youtubeur français Aurelien_Sama ![Aurelien_Sama youtubeur](images/Aurelien_Sama.jpg "Aurelien_Sama Youtubeur"){ width=30 } qui fait plusieurs contenus sur Minecraft dont des nouveautés sur les mises à jour du jeu, des fermes/machines etc.  
    ...
    !!! tip "L'xp c'est quoi ?"
        L'xp, de son nom complet "expérience" se présente sous forme de petites boules de particules vertes ![Xp](images/xp.webp "Expérience"){ width=30 }. Elle s'obtient lorsque le joueur tue avec n'importe quels outils une créature ou alors en cuisant des objets dans un four ![Four](images/blocs/four.webp "Four"){ width=30 } et enfin par des fermes comme celle à or.  
